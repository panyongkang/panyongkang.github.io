...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br />    <a href=\"https://xyyum.icu\" title=\"首页\">首页</a>    <a href=\"https://xyyum.icu\" title=\"留言\">留言</a>    <a href=\"https://xyyum.icu\" title=\"后台\">后台</a> ",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到向阳榆木博客阅读 ' + title + ' ', 6000);
    }
    $(".spig").animate({
